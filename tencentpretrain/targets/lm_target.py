...
class ParallelLmTarget(nn.Module):
    """
...
class LmTarget(nn.Module):
    ...
    def __init__(self, args, vocab_size):
        ...
        self.output_layer = mpu.ColumnParallelLinear(self.hidden_size, self.vocab_size, gather_output=False, skip_bias_add= True,bias =False)
